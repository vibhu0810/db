...
import { Plus, PencilLine, Trash2, Loader2, MoveHorizontal } from "lucide-react";
        ...
        >
          <div className="bg-background p-4 rounded-t-lg border-b">
            <h3 className="font-medium flex items-center">
              ...
              In Progress
              <span className="ml-2 text-xs bg-amber-100 text-amber-800 rounded-full px-2 py-0.5 dark:bg-amber-900 dark:text-amber-200">
